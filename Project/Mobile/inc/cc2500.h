...
//max amount of path data that can be written to FIFO (byte 63 and 64 are needed for address and pktlen
#define AMOUNT_OF_WRITABLE_PATH_DATA 62

//length of path data + address byte
#define PAYLOAD_LENGTH 63

//total number of bytes in fifo
#define SIZE_OF_FIFO 64

//address of base board 
